namespace la {
    ...
    template <class T>
    la::vector_like<T>& tensor<T>::as_vector()
    {
        return data_;
    }

    template <class T>
    la::vector_like<T> const& tensor<T>::as_vector() const
    {
        return data_;
    }

    template <class T>
    la::matrix_like<T>& tensor<T>::as_matrix()
    {
        return mat_;
    }

    template <class T>
    la::matrix_like<T> const& tensor<T>::as_matrix() const
    {
        return mat_;
    }
